...
CREATE TABLE `course` (
    ...
    `status` VARCHAR(20) DEFAULT 'ongoing' COMMENT '状态: ongoing/completed/not_started',
    `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    PRIMARY KEY (`id`),
...
CREATE TABLE `activity_record` (
    ...
    `student_id` BIGINT NOT NULL COMMENT '学生ID',
    `type` VARCHAR(20) NOT NULL DEFAULT 'visit' COMMENT '类型: visit/study/discussion/homework/video',
    `description` TEXT COMMENT '描述',
