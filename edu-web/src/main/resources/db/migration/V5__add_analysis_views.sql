...
CREATE TABLE IF NOT EXISTS `student` (
    ...
    // `grade` VARCHAR(20) NOT NULL COMMENT '年级', 从class获取grade 
    PRIMARY KEY (`id`),
...
CREATE TABLE homework (
    ...
    knowledge_point_id BIGINT DEFAULT 1 COMMENT '知识点ID',
    course_id BIGINT NOT  NULL COMMENT '课程ID',
...
CREATE TABLE `exam` (
    ...
    `status` VARCHAR(20) NOT NULL DEFAULT 'UPCOMING' COMMENT '状态: ONGOING/COMPLETED',
...
CREATE TABLE `activity_record` (
    ...
    `student_id` BIGINT NOT NULL COMMENT '学生ID',
    `type` VARCHAR(20) NOT NULL DEFAULT 'visit' COMMENT '类型: VISIT/EXAM/HOMEWORK/VIDEO/RESOURCE',
